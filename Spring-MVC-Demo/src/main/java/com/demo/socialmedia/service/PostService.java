...
public class PostService {
    ...
    // Lấy newsfeed có phân trang
    public List<Post> getFeedWithPagination(int userId, int limit, int offset) {
        return postDAO.findFeedWithPagination(userId, limit, offset);
    }
