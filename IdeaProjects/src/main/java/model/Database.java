...
public class Database {
    private static final String SERVER_URL = "jdbc:mysql://localhost:1111/?useSSL=false&allowPublicKeyRetrieval=true";
    ...
    public static Connection getConnection() throws SQLException {
        try {
            ...
            String finalUrl = "jdbc:mysql://localhost:1111/" + DB_NAME + "?useSSL=false&useUnicode=true&characterEncoding=UTF-8";
